...
def INDEX():
	...
	addDir('[COLOR lime][B]STEP 2 - INSTALL[/B][/COLOR]',BASEURL,20,ART+'wizard.png',FANART,'')
...
def WIZARD(name,url,description):
    if skin!= "skin.confluence":
	dialog = xbmcgui.Dialog()
        dialog.ok('[COLOR=orange][B]TDB[/B][/COLOR][COLOR=white]  Wizard[/COLOR] ','Please switch to the default Confluence skin','before proceeding.','')
        xbmc.executebuiltin("ActivateWindow(appearancesettings)")
        return
